    ...
    <Heroleft>
      <Inheroleft>
        <Trail open={true}>
          ...
          <span className="text-5xl pt-8 text-slate-300 font-bold">Hello</span>
          ...
          <p className="text-xl pt-6 text-slate-300 italic">
            ...
            mollitia laboriosam consequuntur modi iure dolor repellendus enim
            aut! Eius quisquam harum veritatis mollitia, voluptas non voluptatem
            odit fugit eum.
          </p>
        </Trail>
      </Inheroleft>
